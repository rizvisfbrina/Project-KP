		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="card mt-4">
						<div class="card-body">
							<div class="card-title"><h4><?= $product->product_name; ?></h4></div>
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-sm-4" align="center">
									...
									<input type="hidden" name="product_id" class="form-control" value="<?= $product->product_id; ?>"/>
									<br>
									<button class="btn btn-outline-primary waves-effect" type="button" onclick="addToCart(<?= $product->product_id; ?>)"><span class="fa fa-shopping-cart pull-left"></span>
										Tambahkan</button>
								<br>
								</div>
