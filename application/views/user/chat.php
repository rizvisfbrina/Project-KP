...
<html lang="en">
    ...
    <meta charset="utf-8">
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>style/assets/chat.css" />
        ...
        <script>
            ...
            var sendChat = function (message, callback) {
                $.getJSON('<?php echo base_url(); ?>chat/send_message?message=' + message + '&nickname=' + $('#nickname').val() + '&guid=' + getCookie('user_guid'), function (data){
                    callback();
                });
            }
