                    ...
                    <div class="col-12">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="cart_product_img d-flex align-items-center">
                                            <a href="#"><img src="img/product-img/sekretaris.jpg" alt="Service"></a>
                                            <h6>Sekretaris</h6>
                                        </td>
                        ...
                        <div class="cart-footer d-flex mt-30">
                            <div class="back-to-shop w-50">
                                <a href="shop-grid-left-sidebar.php">Continue Order</a>
                            </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-total-area mt-70">
                            ...
                            <ul class="cart-total-chart">
                                <li><span>Subtotal</span> <span>Rp. 5.000.000</span></li>
                                <li><span>Tax</span> <span>Rp. 500.000</span></li>
                                <li><span><strong>Total</strong></span> <span><strong>Rp. 5.500.000</strong></span></li>
                            </ul>
